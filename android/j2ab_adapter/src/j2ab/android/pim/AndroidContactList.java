...
public class AndroidContactList extends AndroidPIMList implements ContactList {
    ...
    static {
        ...
        DEFAULT_COLUMN_MAPPINGS.put (Contact.FORMATTED_NAME,
                Contacts.PeopleColumns.NAME);
        DEFAULT_COLUMN_TYPES.put (Contacts.PeopleColumns.NAME, String.class);

        // DEFAULT_COLUMN_MAPPINGS.put( Contact.TITLE,
        // Contacts.PeopleColumns.TITLE );
        ...
        // DEFAULT_COLUMN_MAPPINGS.put( Contact.EMAIL,
        // Contacts.ContactMethodsColumns.DATA );
    }

    public AndroidContactList() {
        super ("Contacts", MIDlet.DEFAULT_MIDLET.getContext ()
                .getContentResolver (), Contacts.People.CONTENT_URI, convert (
                DEFAULT_COLUMN_MAPPINGS.values (), new String[] {
    ...
    private class AndroidContact extends PreloadingAndroidPIMItem implements
            Contact {
        ...
        public AndroidContact(Cursor cursor) {
            ...
            String preferredPhoneId = this
                    .getString (Contacts.People.PRIMARY_PHONE_ID);
            String preferredEmailId = this
                    .getString (Contacts.People.PRIMARY_EMAIL_ID);

            Uri emailUri = Contacts.ContactMethods.CONTENT_URI;
            Cursor emailCursor = AndroidContactList.this.contentResolver.query (
                    emailUri, new String[] { Contacts.ContactMethods._ID,
            ...
            int dataColumn = emailCursor
                    .getColumnIndex (Contacts.ContactMethods.DATA);
            int emailTypeColumn = emailCursor
                    .getColumnIndex (Contacts.ContactMethods.TYPE);
            int emailIdColumn = emailCursor
                    .getColumnIndex (Contacts.ContactMethods._ID);
            ...
            Cursor phoneCursor = AndroidContactList.this.contentResolver
                    .query (phoneUri, new String[] { Contacts.Phones._ID,
                            Contacts.Phones.NUMBER, Contacts.Phones.TYPE,
        ...
        public String[] getStringArray (int field, int index) {
            ...
            if (field == Contact.NAME) {
                ...
                result = new String[] { firstName, lastName, title, prefix,
                        postfix };
            } else {
