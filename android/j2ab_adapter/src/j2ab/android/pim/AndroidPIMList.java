...
public abstract class AndroidPIMList implements PIMList {
    ...
    protected AndroidPIMList(String name, ContentResolver contentResolver,
            Uri contentURI, String[] columnNames) {
        this.name = name;
    ...
    public Enumeration items () throws PIMException {
        ...
        Cursor cursor = this.contentResolver.query (this.contentURI,
        ...
        if (cursor == null) {
            ...
            throw new PIMException ("invalid query "
                    + this.contentURI.toString () + " " + columnNames);
        }
