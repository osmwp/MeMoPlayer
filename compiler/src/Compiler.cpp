...
void usage (char * exeName) {
    ...
    printf ("   -I : add paths to search for resources inclusions.\n");
    printf ("        Multiple paths can be defined by using ';' as a separator.\n");
    printf ("   -i : include static resources to the final M4M file (only image, video, audio, css and bml).\n");
    ...
    printf ("   --compat : Use older (<1.5.0) Javascript bytecode format.\n");
    printf ("   --ignore-new-paths : do not follow new paths discovered in source files.\n\n");
    printf ("examples:\n");
    ...
    printf ("   compile index.wrl and search for resources (images, protos, etc...) in forlder ./images.\n");
